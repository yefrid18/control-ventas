...
function EliminarVenta(props) {
    const {id, sendData} = props;
    const handleEliminar = e => {
        let idVentaEliminar = e.target.getAttribute("_id");
        sessionStorage.setItem("idVentaEliminar", idVentaEliminar);
        sendData(idVentaEliminar);
    }
