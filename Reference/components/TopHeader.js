    ...
    <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
        <div className="nv d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white bg-dark">
          ...
          <ul className="nav nav-pills flex-column mb-auto">
            ...
            <li>
              <NavLink exact to="/ventas" className="nav-link text-white" activeClassName="active">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
            ...
            <li>
              <NavLink exact to="/productos" className="nav-link text-white" activeClassName="active">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
